  ...
  return (
    <div className="relative" ref={ref} onFocus={() => setShowSuggestion(true)}>
      ...
      >
        ...
        <div
          className="flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-full bg-white ltr:ml-3.5 rtl:ml-3.5 dark:bg-light-dark"
          onClick={() => closeModal()}
        >
      ...
      >
        <div className="absolute left-2 top-full mt-3.5 w-[90%] rounded-lg bg-white p-5 shadow-large dark:bg-light-dark xs:mt-4 xs:p-6">
